...
The complete video processing pipeline (Figure~\ref{fig:video_generation}) enables zero-shot video editing workflows such as removing specific objects from sports footage or surveillance videos using only natural language descriptions. Processing 81 frames at 480p takes 3-8 minutes on consumer GPUs (GTX 1060 6GB).
