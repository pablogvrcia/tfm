...
\begin{itemize}
    \item \textbf{State-of-the-art open-vocabulary performance} on PASCAL VOC 2012, achieving \textbf{68.09\% mIoU} with CLIP-guided prompting, surpassing previous training-free methods (ITACLIP: 67.9\%)
    \item Exceptional background recognition (86.90\% IoU) through comprehensive descriptor files
    \item Strong class-specific results: Horse (78.49\%), Cat (75.48\%), Aeroplane (76.53\%)
    \item High precision (81.13\%) and pixel accuracy (85.38\%) indicating effective false positive reduction
...
Beyond image segmentation, the work demonstrates that CLIP-guided prompting naturally extends to video by leveraging SAM2's temporal tracking capabilities:
