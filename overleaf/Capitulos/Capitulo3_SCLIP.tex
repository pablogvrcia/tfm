...
\textbf{CLIP-Guided (Ours)} & \checkmark & CSA attention & \textbf{Intelligent prompts} & \textbf{68.09\%} \\
\hline
...
\hline
\textbf{CLIP-Guided (Ours)} & \textbf{Pascal VOC} & \textbf{68.09\%} & \textbf{85.38\%} & \textbf{68.97\%} & \textbf{81.13\%} \\
...
\begin{itemize}
    \item \textbf{68.09\% mIoU}: State-of-the-art training-free open-vocabulary performance
...
\begin{itemize}
    \item Background: 86.90\% - Comprehensive descriptor file coverage
    \item Horse: 78.49\% - Distinctive shape and texture
    \item Aeroplane: 76.53\% - Clear metallic features
    \item Cat: 75.48\% - Clear fur features
    \item Car: 67.84\% - Clear metallic appearance
    \item Train: 65.80\% - Large vehicle, clear boundaries
    \item Bus: 63.91\% - Consistent vehicle recognition
    \item Dog: 61.66\% - Similar to cat benefits
\end{itemize}
