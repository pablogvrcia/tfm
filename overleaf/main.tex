...
% Hyperref for clickable links (must be loaded near the end)
...
\input{Capitulos/01_Introduction.tex}
\input{Capitulos/02_Background.tex}
\input{Capitulos/03_Methodology.tex}
\input{Capitulos/04_Experiments.tex}
...
\input{Capitulos/AnexoB_PromptTemplates.tex}
\input{Anexos/AnexoB_Implementacion.tex}

\input{Anexos/AnexoE_VideoGeneration.tex}
